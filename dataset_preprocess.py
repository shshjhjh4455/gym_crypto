...
if __name__ == "__main__":
    # 데이터셋 로드 및 전처리
    data_frame = preprocess_data("prepare_data/extracted_files/XRPUSDT-trades-2023-10.csv")
    # data_frame 저장
    data_frame.to_csv("prepare_data/data_preprocessed/PP-XRPUSDT-trades-2023-10.csv")